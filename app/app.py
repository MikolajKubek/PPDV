...
from components import (left_foot_walk_visualisation, right_foot_walk_visualisation, anomalies_table,
...
if __name__ == '__main__':
    ...
    initial_data = read_trace(patient_ids[0], get_one_measurement)
    app.layout = dbc.Card(dbc.CardBody([
        ...
        html.Div([
            dbc.Row(html.H4(f'{initial_data["firstname"]}, {initial_data["lastname"]}, {initial_data["birthdate"]}', id="patient_data")),
            dbc.Row([
        ...
        dcc.Store(id='memory', data=initial_data)
